# If-Else: thực hành game Đấm-Lá-Kéo
import random
...
def main():
    ...
    while game_on:
        user_choice = input(f"Game #{counter}. Please input your choice: ")
        ...
        if user_choice == "Q":
            ...
            # print(f"Your selected {user_choice} vs Computer choice is {computer_choice}.") # don't repeat your self (không lập lại công việc có cùng chức năng)
            print(f"Your selected {get_choice(user_choice)} vs Computer choice is {get_choice(computer_choice)}.")
